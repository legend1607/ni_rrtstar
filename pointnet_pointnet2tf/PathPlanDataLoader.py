...
class PathPlanDataset(Dataset):
    def __init__(self, env_type, dataset_filepath):
        """
        env_type: 'random_2d' / 'kuka_xx' 等
        dataset_filepath: e.g. 'data/random_2d/train.npz'
        """
        ...
        self.direction = data["direction"].astype(np.float32) if "direction" in data else np.zeros_like(self.pc)
    ...
    def __getitem__(self, index):
        ...
        direction_labels = self.direction[index]  # (N, 2)
